...
function bc(e, n, t, r, l) {
    switch (n) {
        ...
        case 'gotpointercapture':
            return (o = l.pointerId), jt.set(o, ft(jt.get(o) || null, e, n, t, r, l)), !0;
    }
    return !1;
}
function Os(e) {
...
function bo(e, n, t, r) {
    if (jr) {
        var l = co(e, n, t, r);
        if (l === null) jl(e, n, r, Dr, t), Yu(e, r);
    ...
    ws(function () {
        ...
        if (!(n & 7)) {
            ...
            switch (((_ = c ? Un(c) : window), e)) {
                case 'focusin':
                    (ni(_) || _.contentEditable === 'true') && ((Fn = _), (fo = c), (xt = null));
                    break;
                case 'focusout':
                    xt = fo = Fn = null;
                    break;
            ...
            N &&
                (Ds &&
                    ...
                    (Dn || N !== 'onCompositionStart'
                        ? N === 'onCompositionEnd' && Dn && (x = js())
                        : ((en = v), (eu = 'value' in en ? en.value : en.textContent), (Dn = !0))),
                (_ = Fr(c, N)),
                0 < _.length &&
    ...
    if (U) {
        ...
        if (n) {
            ...
            if (!vi(e, n)) {
                ...
                n = on(t.nextSibling);
                var r = he;
                n && vi(e, n) ? ea(r, t) : ((e.flags = (e.flags & -4097) | 2), (U = !1), (he = e));
            }
        } else {
            if (So(e)) throw Error(y(418));
...
function un(e, n, t) {
    ...
    if (((r = r.shared), R & 2)) {
        var l = r.pending;
        return (
            l === null ? (n.next = n) : ((n.next = l.next), (l.next = n)), (r.pending = n), Ke(e, t)
        );
    }
    return (
        (l = r.interleaved),
...
function Wr(e, n, t, r) {
    ...
    if (i !== null) {
        ...
        v !== null &&
            ...
            (i = v.lastBaseUpdate),
            i !== u &&
                (i === null ? (v.firstBaseUpdate = c) : (i.next = c), (v.lastBaseUpdate = s)));
    }
    if (o !== null) {
        var m = l.baseState;
        (u = 0), (v = c = s = null), (i = o);
...
function ua(e) {
    ...
    function s(f, a, d, h) {
        ...
        return E === jn
            ...
            : a !== null &&
                (a.elementType === E ||
                    (typeof E == 'object' && E !== null && E.$$typeof === Ze && ki(E) === a.type))
...
function ca(e, n) {
    ...
    if (
        ...
        if (((t.flags |= 2048), Qt(9, da.bind(null, t, r, l, n), void 0, null), J === null))
            throw Error(y(349));
        Pn & 30 || fa(t, n, l);
    }
    return l;
...
function Ca(e, n, t) {
    return Pn & 21
        ? (Me(t, n) || ((t = Ns()), (V.lanes |= t), (zn |= t), (e.baseState = !0)), n)
...
function nd(e, n, t) {
    ...
    if (xa(e)) Na(n, l);
        ...
        (t = ta(e, n, l, r)), t !== null && ((l = ue()), Oe(t, e, r, l), Pa(t, n, r));
    }
}
function xa(e) {
    var n = e.alternate;
...
function zi(e, n, t, r, l) {
    ...
    if (((o = e.child), !(e.lanes & l))) {
        ...
        if (((t = t.compare), (t = t !== null ? t : It), t(u, r) && e.ref === n.ref))
            return Ye(e, n, l);
    }
            ...
            if (((r = n.memoizedState), r !== null))
                return r.dehydrated !== null
                    ...
                    : t & n.child.childLanes
                      ? ja(e, n, t)
                      : (M($, $.current & 1), (e = Ye(e, n, t)), e !== null ? e.sibling : null);
            M($, $.current & 1);
            break;
        case 19:
        ...
        case 13:
            ...
            return n.flags & 128
                ...
                : ((r = r !== null),
                  ...
                  null);
        case 4:
            return nt(), To(e, n), e === null && Ut(n.stateNode.containerInfo), te(n), null;
        case 10:
...
function $a(e) {
    ...
    n !== null && ((e.alternate = null), $a(n)),
        ...
        e.tag === 5 &&
            ((n = e.stateNode),
            n !== null && (delete n[Fe], delete n[Vt], delete n[go], delete n[Xf], delete n[Gf])),
        (e.stateNode = null),
        (e.return = null),
        (e.dependencies = null),
    ...
    switch (e.tag) {
        ...
        case 22:
            if (
                ...
                if (
                    ((c = e.memoizedState !== null), (e.stateNode.isHidden = c) && !v && e.mode & 1)
                )
...
function Wa(e, n) {
    ...
    if (r & 30 || r & e.expiredLanes || n) n = Jr(e, r);
        ...
        while (!0);
        au(), (Xr.current = o), (R = l), K !== null ? (n = 0) : ((J = null), (b = 0), (n = X));
    }
    if (n !== 0) {
        if ((n === 2 && ((l = so(e)), l !== 0 && ((r = l), (n = Io(e, l)))), n === 1))
        ...
        if (n === 6) be(e, r);
            ...
            switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    if ((be(e, r), (r & 130023424) === r && ((n = _u + 500 - Q()), 10 < n))) {
                        if (Mr(e, 0) !== 0) break;
        ...
        try {
            ...
            e: {
                ...
                if (
                    ...
                    var F = xi(u);
                    if (F !== null) {
                        !(F.flags & 65536) && (F.flags |= 256), Ni(F, u, i, o, n), iu(tt(s, i));
                        break e;
                    }
                }
                (o = s = tt(s, i)),
...
function Jr(e, n) {
    ...
    while (!0);
    if ((au(), (R = t), (Xr.current = r), K !== null)) throw Error(y(261));
    return (J = null), (b = 0), X;
}
function hd() {
    for (; K !== null; ) Ya(K);
...
Za = function (e, n, t) {
    ...
    switch (((n.lanes = 0), n.tag)) {
        ...
        case 14:
            return (
                (r = n.type), (l = ze(r, n.pendingProps)), (l = ze(r.type, l)), zi(e, n, r, l, t)
            );
        case 15:
    ...
    switch (e.tag) {
        case 3:
            ...
            if (n.current.memoizedState.isDehydrated) {
                ...
                t !== 0 && (Jo(n, t | 1), pe(n, Q()), !(R & 6) && ((rt = Q() + 500), vn()));
            }
            break;
        case 13:
            Ln(function () {
...
function Rd() {
    return I.jsx(I.Fragment, { children: 'LPANE' });
}
const Od = '/assets/react-h3aPdYU7.svg',
    Md = '/vite.svg';
function jd() {
            ...
            I.jsxs('div', {
                children: [
                    I.jsx('a', {
                        ...
                        target: '_blank',
                        children: I.jsx('img', { src: Md, className: 'logo', alt: 'Vite logo' })
                    }),
                    I.jsx('a', {
            ...
            I.jsxs('div', {
                ...
                children: [
                    ...
                    I.jsxs('p', {
                        children: [
                            'Edit ',
                            I.jsx('code', { children: 'src/App.tsx' }),
...
function Dd() {
    return I.jsx(I.Fragment, {
        children: I.jsxs('div', {
            ...
            children: [
                I.jsx('div', { className: 'panel', children: I.jsx(Rd, {}) }),
                I.jsx('div', { className: 'paner', children: I.jsx(jd, {}) })
            ]
        })
    });
}
Ql.createRoot(document.getElementById('root')).render(
    I.jsx(wc.StrictMode, { children: I.jsx(Dd, {}) })
);
